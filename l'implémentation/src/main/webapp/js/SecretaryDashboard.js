...
function create_Upcoming_Acts(){
	...
	for (let i=0;i<keys.length;i++){
		...
		for (let arr in apptValues){
			...
			if(ApptArray[0]!= undefined && ApptArray[1]!= undefined){
				...
				console.log(ApptArray[0].client.image.substring(0,5) );
				if(ApptArray[0].client.image.substring(0,5) == "https"){
					image.src=ApptArray[0].client.image;
				}else{
