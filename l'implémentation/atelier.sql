...
INSERT INTO `carproblem` VALUES (1,'202212521','problem with the engine','engine','completed','2022-06-14'),(2,'202212521','problem with the brakes','brakes','active','2022-06-14'),(3,'202212520','accident accured','accident','completed','2022-06-14'),(4,'202212519','problem with the tires','tire','pending','2022-06-13'),(5,'202212521','problem with the engine','engine','pending','2022-06-13'),(6,'202212521','problem with the brakes','brakes','pending','2022-06-13'),(7,'202212520','accident accured','accident','pending','2022-06-15'),(8,'202212519','problem with the tires','tire','active','2022-06-12'),(9,'202212521','problem with the engine','engine','active','2022-06-12'),(10,'202212521','problem with the brakes','brakes','completed','2022-06-15'),(11,'202212520','accident accured','accident','active','2022-06-15'),(12,'202212519','problem with the tires','tire','completed','2022-06-13'),(13,'202212521','problem with the engine','engine','completed','2022-05-14'),(14,'202212521','problem with the brakes','brakes','active','2022-05-14'),(16,'202212519','problem with the tires','tire','pending','2022-05-13'),(17,'202212521','problem with the engine','engine','pending','2022-05-13'),(23,'202212520','accident accured','accident','active','2022-05-15'),(24,'202212519','problem with the tires','tire','completed','2022-05-13'),(25,'202212521','problem with the engine','engine','completed','2022-04-14'),(26,'202212521','problem with the brakes','brakes','active','2022-04-14'),(27,'202212520','accident accured','accident','completed','2022-04-14'),(28,'202212519','problem with the tires','tire','pending','2022-04-13'),(29,'202212521','problem with the engine','engine','pending','2022-04-13'),(30,'202212521','problem with the brakes','brakes','pending','2022-04-13'),(31,'202212520','accident accured','accident','pending','2022-04-15'),(35,'202212520','accident accured','accident','active','2022-04-15'),(36,'202212519','problem with the tires','tire','completed','2022-04-13'),(37,'202212521','problem with the engine','engine','completed','2022-03-14'),(38,'202212521','problem with the brakes','brakes','active','2022-03-14'),(39,'202212520','accident accured','accident','completed','2022-03-14'),(40,'202212519','problem with the tires','tire','pending','2022-03-13'),(41,'202212521','problem with the engine','engine','pending','2022-03-13'),(42,'202212521','problem with the brakes','brakes','pending','2022-03-13'),(43,'202212520','accident accured','accident','pending','2022-03-15'),(44,'202212519','problem with the tires','tire','active','2022-03-12'),(45,'202212521','problem with the engine','engine','active','2022-03-12'),(46,'202212521','problem with the brakes','brakes','completed','2022-03-15'),(47,'202212520','accident accured','accident','active','2022-03-15'),(48,'202212519','problem with the tires','tire','completed','2022-03-13'),(49,'202212521','problem with the engine','engine','completed','2022-02-14'),(50,'202212521','problem with the brakes','brakes','active','2022-02-14'),(51,'202212520','accident accured','accident','completed','2022-02-14'),(52,'202212519','problem with the tires','tire','pending','2022-02-13'),(53,'202212521','problem with the engine','engine','pending','2022-02-13'),(54,'202212521','problem with the brakes','brakes','pending','2022-02-13'),(55,'202212520','accident accured','accident','pending','2022-02-15'),(59,'202212520','accident accured','accident','active','2022-02-15'),(60,'202212519','problem with the tires','tire','completed','2022-02-13'),(61,'202212521','problem with the engine','engine','completed','2022-01-14'),(62,'202212521','problem with the brakes','brakes','active','2022-01-14'),(64,'202212519','problem with the tires','tire','pending','2022-01-13'),(65,'202212521','problem with the engine','engine','pending','2022-01-13'),(66,'202212521','problem with the brakes','brakes','pending','2022-01-13'),(70,'202212521','problem with the brakes','brakes','completed','2022-01-15'),(71,'202212520','accident accured','accident','active','2022-01-15'),(72,'202212519','problem with the tires','tire','completed','2022-01-13'),(73,'202212521','problem with the engine','engine','completed','2022-12-14'),(74,'202212521','problem with the brakes','brakes','active','2022-12-14'),(75,'202212520','accident accured','accident','completed','2022-12-14'),(76,'202212519','problem with the tires','tire','pending','2022-12-13'),(77,'202212521','problem with the engine','engine','pending','2022-12-13'),(78,'202212521','problem with the brakes','brakes','pending','2022-12-13'),(79,'202212520','accident accured','accident','pending','2022-12-15'),(80,'202212519','problem with the tires','tire','active','2022-12-12'),(81,'202212521','problem with the engine','engine','active','2022-12-12'),(82,'202212521','problem with the brakes','brakes','completed','2022-12-15'),(83,'202212520','accident accured','accident','active','2022-12-15'),(84,'202212519','problem with the tires','tire','completed','2022-12-13');
...
INSERT INTO `carreviews` VALUES (1,'202212521','1@email.com','Great Car , I recommend','2022-05-08 10:00:00'),(2,'202212519','Hamza@gmail.com','Great Car , Great Team , awsome cutomer service , I recommend','2022-05-15 10:00:00'),(3,'202212520','1@email.com','Great Car , Great Team , awsome cutomer service , I recommend','2022-05-25 10:00:00'),(4,'202212520','1@email.com','awsome services.','2022-06-08 10:00:00'),(5,'202212520','Hamza@gmail.com','i like it','2022-06-11 10:00:00'),(10,'202212521','1@email.com','Great Car , I recommend','2022-05-19 10:00:00'),(11,'202212521','1@email.com','Great Car , I like it','2022-06-02 10:00:00'),(12,'202212519','Hamza@gmail.com','great experience','2022-06-14 10:00:00');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `conversation_BEFORE_DELETE` BEFORE DELETE ON `conversation` FOR EACH ROW BEGIN
DELETE FROM `atelier`.`messages` WHERE (`id_conversation` = OLD.`id`);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
UPDATE `atelier`.`secretary` SET `working_location` = NULL WHERE (`working_location` = OLD.`code`);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `secretary_AFTER_UPDATE` AFTER UPDATE ON `secretary` FOR EACH ROW BEGIN
IF (OLD.`working_location` <> NEW.`working_location`) THEN
UPDATE `atelier`.`offices` SET `email_secretaire` = NULL WHERE (`code` = OLD.`working_location`) and (`agency_name` = OLD.`agency_name`);
UPDATE `atelier`.`offices` SET `email_secretaire` = NEW.`email` WHERE (`code` = NEW.`working_location`) and (`agency_name` = NEW.`agency_name`);
END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
DELETE FROM `atelier`.`conversation` WHERE (`source` = OLD.`email` OR `destination` = OLD.`email`);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2022-06-13 17:37:35
